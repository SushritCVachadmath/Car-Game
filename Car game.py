...
def countdown_background():
    countdown=mixer.Sound("coun.mp3")
    countdown.play()
    ...
    text=font.render("DODGED: 0",True, green)
...
def countdown():
    ...
    while countdown:
            ...
            pygame.display.update()
            clock.tick(1)
            gamedisplays.fill(bright_green)
            countdown_background()
            largetext=pygame.font.Font('freesansbold.ttf',115)
            ...
            countdown_background()
            largetext=pygame.font.Font('freesansbold.ttf',115)
            TextSurf,TextRect=text_objects(" LET'S GO!",largetext)
            TextRect.center=((display_width/2),(display_height/2))
            gamedisplays.blit(TextSurf,TextRect)
            pygame.display.update()
            clock.tick(1)
...
def score_system(passed,score):
    font=pygame.font.SysFont(None,25)
    text=font.render("Passed"+str(passed),True,green)
...
def game_loop():
    ...
    while not bumped:
        ...
        if obs_starty>display_height:
            ...
            if int(passed)%10==0:
                level=level+1
                obstacle_speed=obstacle_speed+3
                largetext=pygame.font.Font("freesansbold.ttf",80)
